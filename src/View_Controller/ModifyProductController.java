...
import static View_Controller.MainScreenController.getSelectedProductIndex;
...
public class ModifyProductController implements Initializable {
    ...
    @FXML
    private void modifyProductSearchPartButton(ActionEvent event) throws IOException {
        String searchPart = partSearchTextField.getText().trim();
        modifyProductPartsTableView.setItems(Inventory.lookUpPart(searchPart));
        modifyProductPartsTableView.refresh();
    }

    @FXML
    private void modifyProductClearSearchPart(ActionEvent event) throws IOException {
    ...
    @FXML
    private void modifyProductSaveButtonClicked(ActionEvent event) throws IOException {
    ...
    public void updatePartsTableView() {
        modifyProductPartsTableView.setItems(getAllParts());
    }
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        productInvTextField.setText(Integer.toString(product.getProductStock()));
        productPriceTextField.setText(Double.toString(product.getProductPrice()));
        productMaxTextField.setText(Integer.toString(product.getMaxProductStock()));
        productMinTextField.setText(Integer.toString(product.getMinProductStock()));
